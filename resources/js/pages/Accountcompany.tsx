    ...
    <div className='min-h-screen w-full flex flex-col bg-white'>
        <div className='h-[550px] w-full relative rounded-b-[60px] overflow-hidden'>
            ...
            <div className=' flex  items-center relative w-full  h-40 px-20 '>
                <div onClick={() => router.visit("/dashboard")} className=" absolute  top-1/2 -translate-y-1/2 cursor-pointer px-10 z-50 ">
        ...
        <div className='flex flex-col w-full items-center justify-center mt-13'>
            <div className='gap-2  flex flex-col mb-3 ' >
                ...
                <input type='text' className='border border-gray-400 rounded-xl px-10 py-5 w-[800px]' value={company?.name || ""} readOnly></input>
            </div>
            <div className='gap-2  flex flex-col ' >
                <label className='font-bold text-xl text-black'>Password</label>
                <input type='password' className='border border-gray-400 rounded-xl px-10 py-5 w-[800px]'value="********" readOnly></input>
            </div>
            <div className='gap-2  flex flex-col mb-3 ' >
                <label className='font-bold text-xl text-black'>Email Address</label>
                <input type='email' className='border border-gray-400 rounded-xl px-10 py-5 w-[800px]'value={company?.email || ""} readOnly></input>
            </div>
            <div className='gap-2  flex flex-col ' >
                <label className='font-bold text-xl text-black'>Certificate Company</label>
                <input type='file' className='border border-gray-400 rounded-xl px-10 py-5 w-[800px] cursor-pointer'></input>
            </div>
        </div>
        <div className='flex w-full items-center justify-center mt-10 gap-10'>
                <button onClick={() => router.visit('/account-company/editaccount-company')} className='bg-[#2C3638] rounded-lg justify-start text-white text-center px-8 py-3 font-bold cursor-pointer mb-20'>Edit</button>

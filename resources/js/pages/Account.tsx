    ...
    <div className='min-h-screen w-full flex flex-col bg-white'>
        <div className='h-[550px] w-full relative rounded-b-[60px] overflow-hidden'>
            ...
            <div className=' flex  items-center relative w-full  h-40 px-20 '>
                <div onClick={() => router.visit("/home")} className=" absolute  top-1/2 -translate-y-1/2 cursor-pointer px-10 z-50 ">
                ...
                <div className='items-center justify-center flex flex-col inset-0 absolute pt-50 '>
                    <div>
                        <img src={Logo} alt="Logo" className='w-[400px] mb-3' />
                    </div>
                    <div className='px-10'>
        ...
        <div className='flex flex-col w-full items-center justify-center mt-13'>
            <div className='gap-2  flex flex-col mb-3 ' >
                ...
                <input type='text' className='border border-gray-400 rounded-xl px-10 py-3 w-[800px]'></input>
            </div>
            <div className='gap-2  flex flex-col ' >
                <label className='font-bold text-black'>Password</label>
                <input type='password' className='border border-gray-400 rounded-xl px-10 py-3 w-[800px]'></input>
                <div onClick={() => router.visit("/account/change-password")} className='self-end cursor-pointer text-blue-400 font-semibold '>Change</div>
            </div>
            <div className='gap-2  flex flex-col ' >
                <label className='font-bold text-black'>Email Address</label>
                <input type='email' className='border border-gray-400 rounded-xl px-10 py-3 w-[800px]'></input>
            </div>
            <div className='flex mt-10'>
                <button onClick={() => router.visit('/login')} className='bg-[#2C3638] rounded-lg text-white text-center px-5 py-3 font-bold cursor-pointer'>Log Out</button>
            </div>
        </div>

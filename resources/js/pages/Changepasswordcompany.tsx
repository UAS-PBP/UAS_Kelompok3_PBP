...
const Changepasswordcompany: FC = () => {
  ...
  return (
    <div className='min-h-screen w-full flex flex-col bg-white'>
        <div className=' flex  items-center relative w-full h-40 px-10 '>
            <div onClick={() => router.visit("/account-company")} className=" absolute  top-1/2 -translate-y-1/2 cursor-pointer px-10 ">
        ...
        <div className='flex flex-col gap-8 w-full items-center justify-center mt-30'>
            <div className='gap-2  flex flex-col ' >
                ...
                <input type='text' className='border border-gray-400 rounded-xl px-10 py-3 w-[750px]'value={data.old_password}></input>
            </div>
            <div className='gap-2  flex flex-col  ' >
                <label className='font-bold text-black'>New Password</label>
                <input type='password' className='border border-gray-400 rounded-xl px-10 py-3 w-[750px]' value={data.password}></input>
            </div>
            <div className='gap-2  flex flex-col ' >
                <label className='font-bold text-black'>Confirm New Password</label>
                <input type='email' className='border border-gray-400 rounded-xl px-10 py-3 w-[750px]'value={data.password_confirmation}></input>
            </div>

...
const Footer: FC = () => {
  return (
    <footer className="w-full bg-[#2A3335] text-white py-10 px-3">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-[50px]">
        ...
        <div className="px-20 md:px-0">
          ...
          <ul className="space-y-2 opacity-80">
            <li onClick={() => router.visit('/home')} className="cursor-pointer hover:text-[#dbb770]">Home</li>
            <li onClick={() => router.visit('/promo')} className="cursor-pointer hover:text-[#dbb770]">Promo</li>
            <li onClick={() => router.visit('/history')} className="cursor-pointer hover:text-[#dbb770]">History</li>
            <li onClick={() => router.visit('/chat')} className="cursor-pointer hover:text-[#dbb770]">Chat</li>
            <li onClick={() => router.visit('/account')} className="cursor-pointer hover:text-[#dbb770]">Account</li>
          </ul>
        </div>
